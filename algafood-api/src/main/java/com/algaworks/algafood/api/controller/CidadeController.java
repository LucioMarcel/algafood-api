...
//	public ResponseEntity<?> trataEntidadeNaoEncontradoException(EntidadeNaoEncontradaException e) {
...
//	public ResponseEntity<?> trataNegocioException(NegocioExceprion e) {
//		Problem problema = Problem.builder()
//				.dataHora(LocalDateTime.now())
//				.mensagem(e.getMessage()).build();
//		
