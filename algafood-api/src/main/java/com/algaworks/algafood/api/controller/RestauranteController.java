...
import com.algaworks.algafood.api.assembler.RestauranteInputDisasembler;
...
public class RestauranteController {
	...
	@Autowired
	private RestauranteInputDisasembler restauranteInputDisasembler;
...
//	}
	...
	public void merge(Map<String, Object> dadosOrigem, Restaurante restauranteDestino, HttpServletRequest request) {
		...
		try {
			...
			objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, true);  // não precisa, pois é padrão.
		
			Restaurante restauranteOrigem = objectMapper.convertValue(dadosOrigem, Restaurante.class);
			
			dadosOrigem.forEach((nomePropriedade, valorProriedade) -> {
