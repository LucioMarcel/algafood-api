...
//Especificação do Problem Details for HTTP APIs (RFC 7807)
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
		...
		Problem problem = handleValidationInternal(status, ex.getBindingResult());
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpHeaders headers,
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', que é de um tipo inválido. " +
				"Corrija ou informe um valor compatível com o tipo '%s'.", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
		
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(String.format("O valor '%s' informado é invalido." , ex.getValue()))
				.build();
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		String detail = String.format("A propriedade '%s' recebeu o valor '%s', "
				+ "que é de um tipo invállido. Corrija e informe um valor compatível com o tipo %s.",
	...
	public ResponseEntity<?> handlentidadeNaoEncontrado(EntidadeNaoEncontradaException ex, WebRequest request) {
